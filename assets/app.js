...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    if (m) {
      ...
      var pages = mx
        ? ["a1-why-a-warehouse.html", "a2-shape-of-a-warehouse.html",
           "a3-one-truth-problem.html", "a4-buy-landscape.html",
           "a5-cost-and-performance.html", "a6-warehouse-in-ai-era.html"]
        : ["b1-row-store-column-store.html", "b2-architecture-staging.html", "b3-facts-dimensions.html",
           "b4-building-dimensions.html", "b5-scd-in-practice.html",
           "b6-loading-patterns.html", "b7-marts-serving.html",
           "b8-performance-cost.html", "b9-lakehouse-modern-stack.html", "b10-capstone.html"];
