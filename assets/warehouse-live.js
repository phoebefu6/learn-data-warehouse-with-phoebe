/* learn-data-warehouse-with-phoebe - live warehouse playground engine
...
(function () {
  ...
  /* split a script into statements on ';' (course content never embeds
     semicolons inside string literals - keep examples that way) */
  function splitSql(script) {
    return script.split(";").map(function (s) { return s.trim(); })
